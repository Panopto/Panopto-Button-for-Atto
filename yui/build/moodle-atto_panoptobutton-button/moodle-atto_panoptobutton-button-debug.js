...
Y.namespace('M.atto_panoptobutton').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    initializer: function () {
        ...
        //Get the external of the course, and if it exists, append to the url for the iframe
        ...
        eventEnter(messageEvent, function (e) {
            ...
            if (message.cmd === 'deliveryList') {
                ...
                for (var value in ids) {
                    iframestring += "<embed src='http://" + servername + "/Panopto/Pages/Embed.aspx?id=" + ids[value] + "&v=1' width='450' height='300' frameborder='0'><br>";
                }

                parent.editor.focus();
                parent.get('host').insertContentAtFocusPoint(iframestring);
                parent.markUpdated();
            }
        }, false);
    }
